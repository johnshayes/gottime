...
--
-- Name: ar_internal_metadata; Type: TABLE; Schema: public; Owner: frederike
--
...
ALTER TABLE ar_internal_metadata OWNER TO frederike;

--
-- Name: blacklists; Type: TABLE; Schema: public; Owner: frederike
--
...
ALTER TABLE blacklists OWNER TO frederike;

--
-- Name: blacklists_id_seq; Type: SEQUENCE; Schema: public; Owner: frederike
--
...
ALTER TABLE blacklists_id_seq OWNER TO frederike;

--
-- Name: blacklists_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: frederike
--
...
--
-- Name: chat_rooms; Type: TABLE; Schema: public; Owner: frederike
--
...
ALTER TABLE chat_rooms OWNER TO frederike;

--
-- Name: chat_rooms_id_seq; Type: SEQUENCE; Schema: public; Owner: frederike
--
...
ALTER TABLE chat_rooms_id_seq OWNER TO frederike;

--
-- Name: chat_rooms_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: frederike
--
...
--
-- Name: listings; Type: TABLE; Schema: public; Owner: frederike
--
...
ALTER TABLE listings OWNER TO frederike;

--
-- Name: listings_id_seq; Type: SEQUENCE; Schema: public; Owner: frederike
--
...
ALTER TABLE listings_id_seq OWNER TO frederike;

--
-- Name: listings_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: frederike
--
...
--
-- Name: meetings; Type: TABLE; Schema: public; Owner: frederike
--
...
ALTER TABLE meetings OWNER TO frederike;

--
-- Name: meetings_id_seq; Type: SEQUENCE; Schema: public; Owner: frederike
--
...
ALTER TABLE meetings_id_seq OWNER TO frederike;

--
-- Name: meetings_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: frederike
--
...
--
-- Name: messages; Type: TABLE; Schema: public; Owner: frederike
--
...
ALTER TABLE messages OWNER TO frederike;

--
-- Name: messages_id_seq; Type: SEQUENCE; Schema: public; Owner: frederike
--
...
ALTER TABLE messages_id_seq OWNER TO frederike;

--
-- Name: messages_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: frederike
--
...
--
-- Name: participants; Type: TABLE; Schema: public; Owner: frederike
--
...
ALTER TABLE participants OWNER TO frederike;

--
-- Name: participants_id_seq; Type: SEQUENCE; Schema: public; Owner: frederike
--
...
ALTER TABLE participants_id_seq OWNER TO frederike;

--
-- Name: participants_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: frederike
--
...
--
-- Name: schema_migrations; Type: TABLE; Schema: public; Owner: frederike
--
...
ALTER TABLE schema_migrations OWNER TO frederike;

--
-- Name: users; Type: TABLE; Schema: public; Owner: frederike
--
...
ALTER TABLE users OWNER TO frederike;

--
-- Name: users_id_seq; Type: SEQUENCE; Schema: public; Owner: frederike
--
...
ALTER TABLE users_id_seq OWNER TO frederike;

--
-- Name: users_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: frederike
--
...
--
-- Name: blacklists id; Type: DEFAULT; Schema: public; Owner: frederike
--
...
--
-- Name: chat_rooms id; Type: DEFAULT; Schema: public; Owner: frederike
--
...
--
-- Name: listings id; Type: DEFAULT; Schema: public; Owner: frederike
--
...
--
-- Name: meetings id; Type: DEFAULT; Schema: public; Owner: frederike
--
...
--
-- Name: messages id; Type: DEFAULT; Schema: public; Owner: frederike
--
...
--
-- Name: participants id; Type: DEFAULT; Schema: public; Owner: frederike
--
...
--
-- Name: users id; Type: DEFAULT; Schema: public; Owner: frederike
--
...
--
-- Data for Name: ar_internal_metadata; Type: TABLE DATA; Schema: public; Owner: frederike
--
...
--
-- Data for Name: blacklists; Type: TABLE DATA; Schema: public; Owner: frederike
--
...
--
-- Name: blacklists_id_seq; Type: SEQUENCE SET; Schema: public; Owner: frederike
--
...
--
-- Data for Name: chat_rooms; Type: TABLE DATA; Schema: public; Owner: frederike
--
...
--
-- Name: chat_rooms_id_seq; Type: SEQUENCE SET; Schema: public; Owner: frederike
--
...
--
-- Data for Name: listings; Type: TABLE DATA; Schema: public; Owner: frederike
--
...
--
-- Name: listings_id_seq; Type: SEQUENCE SET; Schema: public; Owner: frederike
--
...
--
-- Data for Name: meetings; Type: TABLE DATA; Schema: public; Owner: frederike
--
...
--
-- Name: meetings_id_seq; Type: SEQUENCE SET; Schema: public; Owner: frederike
--
...
--
-- Data for Name: messages; Type: TABLE DATA; Schema: public; Owner: frederike
--
...
--
-- Name: messages_id_seq; Type: SEQUENCE SET; Schema: public; Owner: frederike
--
...
--
-- Data for Name: participants; Type: TABLE DATA; Schema: public; Owner: frederike
--
...
--
-- Name: participants_id_seq; Type: SEQUENCE SET; Schema: public; Owner: frederike
--
...
--
-- Data for Name: schema_migrations; Type: TABLE DATA; Schema: public; Owner: frederike
--
...
--
-- Data for Name: users; Type: TABLE DATA; Schema: public; Owner: frederike
--
...
3	fkugland@mac.com	$2a$11$vOcM.kSFnPMleLLm/4AjbO7/gja81m9crCA2ZRSKXUVxE9/FwTpdS	\N	\N	\N	23	2017-09-04 10:01:38.445998	2017-09-01 10:42:50.268824	127.0.0.1	127.0.0.1	2017-08-30 13:35:47.082354	2017-09-04 14:26:48.907908	Frederike	Kugland	\N	\N	\N	\N	\N	facebook	1626632277356399	https://graph.facebook.com/v2.6/1626632277356399/picture?type=square	\N	\N	EAAYwEKxaN7ABANUD3WmEaVUjhGac7OTH7RvRm5MQgSqXW8ZBppfHWiLUBx3mH14ry3wXvZB5OoHbZCj5ljKEMgT6LTZCiBbqENtXBxBxub1joVQbhxQJiwBK4Q4CtZBQ2ZBtSQezfzNGauReAELdAyzp1iK6P4d5crTZAjt8XJrYAZDZD	2017-11-03 10:01:36	\N	\N	t
\.


--
-- Name: users_id_seq; Type: SEQUENCE SET; Schema: public; Owner: frederike
--
...
--
-- Name: ar_internal_metadata ar_internal_metadata_pkey; Type: CONSTRAINT; Schema: public; Owner: frederike
--
...
--
-- Name: blacklists blacklists_pkey; Type: CONSTRAINT; Schema: public; Owner: frederike
--
...
--
-- Name: chat_rooms chat_rooms_pkey; Type: CONSTRAINT; Schema: public; Owner: frederike
--
...
--
-- Name: listings listings_pkey; Type: CONSTRAINT; Schema: public; Owner: frederike
--
...
--
-- Name: meetings meetings_pkey; Type: CONSTRAINT; Schema: public; Owner: frederike
--
...
--
-- Name: messages messages_pkey; Type: CONSTRAINT; Schema: public; Owner: frederike
--
...
--
-- Name: participants participants_pkey; Type: CONSTRAINT; Schema: public; Owner: frederike
--
...
--
-- Name: schema_migrations schema_migrations_pkey; Type: CONSTRAINT; Schema: public; Owner: frederike
--
...
--
-- Name: users users_pkey; Type: CONSTRAINT; Schema: public; Owner: frederike
--
...
--
-- Name: index_blacklists_on_user_id; Type: INDEX; Schema: public; Owner: frederike
--
...
--
-- Name: index_chat_rooms_on_meeting_id; Type: INDEX; Schema: public; Owner: frederike
--
...
--
-- Name: index_listings_on_user_id; Type: INDEX; Schema: public; Owner: frederike
--
...
--
-- Name: index_meetings_on_listing_id; Type: INDEX; Schema: public; Owner: frederike
--
...
--
-- Name: index_messages_on_chat_room_id; Type: INDEX; Schema: public; Owner: frederike
--
...
--
-- Name: index_messages_on_user_id; Type: INDEX; Schema: public; Owner: frederike
--
...
--
-- Name: index_participants_on_meeting_id; Type: INDEX; Schema: public; Owner: frederike
--
...
--
-- Name: index_participants_on_user_id; Type: INDEX; Schema: public; Owner: frederike
--
...
--
-- Name: index_users_on_email; Type: INDEX; Schema: public; Owner: frederike
--
...
--
-- Name: index_users_on_reset_password_token; Type: INDEX; Schema: public; Owner: frederike
--
...
--
-- Name: messages fk_rails_00aac238e8; Type: FK CONSTRAINT; Schema: public; Owner: frederike
--
...
--
-- Name: blacklists fk_rails_23fa4463b8; Type: FK CONSTRAINT; Schema: public; Owner: frederike
--
...
--
-- Name: messages fk_rails_273a25a7a6; Type: FK CONSTRAINT; Schema: public; Owner: frederike
--
...
--
-- Name: participants fk_rails_59ae73a91d; Type: FK CONSTRAINT; Schema: public; Owner: frederike
--
...
--
-- Name: participants fk_rails_b9a3c50f15; Type: FK CONSTRAINT; Schema: public; Owner: frederike
--
...
--
-- Name: listings fk_rails_baa008bfd2; Type: FK CONSTRAINT; Schema: public; Owner: frederike
--
...
--
-- Name: meetings fk_rails_bb617aa3bf; Type: FK CONSTRAINT; Schema: public; Owner: frederike
--
...
--
-- Name: chat_rooms fk_rails_d0dd415561; Type: FK CONSTRAINT; Schema: public; Owner: frederike
--
